<!DOCTYPE html><html lang="en"><head><title><?php echo TITLE ?></title>
 <!-- Bootstrap CSS -->
 ...
 <!-- Custom CSS -->
 <link rel="stylesheet" href="../css/adminstyle.css"></head><body>
 <!-- Top Navbar -->
 <nav class="navbar  p-1 shadow" style="background-color: #3E3D3D;">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="adminDashboard.php">SkillShare <small class="text-white">Admin Area</small></a> </nav>
 <!-- Side Bar -->
 <div class="container-fluid mb-5" style="margin-top:40px;"><div class="row">
   <nav class="col-sm-3 col-md-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column"><?php define('PAGE', 'dashboard'); ?>
      <li class="nav-item">
      ...
      <li class="nav-item">
       <a class="nav-link" href="../logout.php">
        <i class="fas fa-sign-out-alt"></i>Logout</a></li></ul></div></nav>